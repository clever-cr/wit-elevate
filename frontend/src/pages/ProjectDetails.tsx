...
const ProjectDetails = () => {
  ...
  const project = {
    ...
    team: [
      { name: "Keza Kami", role: "Frontend Lead", avatar: "KK" },
      { name: "Maria Umukundwa", role: "Backend Developer", avatar: "MU" },
      { name: "Carla", role: "UI/UX Designer", avatar: "C" }
    ],
    supervisor: { 
      name: "Clever Umuhuza", 
      avatar: "CU",
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <a 
                          href="https://github.com/clever-cr/E-commerce-Platform"
