...
{course.isLoading ? <h1>Loading...</h1> : allCourses?.length<0 || !allCourses ? (
      ...
      <div className="bg-white flex flex-col items-center gap-11 px-28 py-28 rounded-3xl ml-5 mt-10">
        ...
        <p className="text-sm max-w-md text-center">
          Welcome!
          By clicking on complete your profile your data will be kept safe and secure. And use AI to provide your personalised learning path
          If you agree with this terms and condtions click on Complete your profile or cancel the process and go back to landing page
           Now  complete your profile, to be able to start your
          journey by creating your learning path. Complete you profile to get started.
        </p>
        <div className='flex items-center gap-2'>
        <Link to="/user/portal/profileUpdate">
        <Button
        ...
        <Button
          text="Cancel process"
          loading={course.isLoading}
          className="bg-slate-600 px-16 py-4 rounded-xl text-white flex-row-reverse"
        />
         </Link>
        </div>
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 mb-8 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {userBadges.map((badge) => (
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">{badge.name.split("_")[0]}</h3>
