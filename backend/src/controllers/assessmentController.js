...
export const getAssessments = async (req, res) => {
  try {
    ...
    const userCategory = await User.findById(id).select('developmentInterest');
    const query = { isActive: true,category:userCategory.developmentInterest.toLowerCase() };
